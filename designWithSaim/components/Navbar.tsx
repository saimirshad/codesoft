...
const Navbar = () => {
  ...
  return (
    <div className="px-4 w-full shadow-navbarShadow h-20 lg:h-[10vh] sticky top-0 z-50 bg-bodyColor 
    text-sm md:text-base p-2 md:p-6 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-80">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        >
          <a href="#home" onClick={handleScroll}><Image className="w-32" src={logo} alt="logo" /></a>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                href="mailto:saimirshad676@gmail.com"
              >
                <p>saimirshad676@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
